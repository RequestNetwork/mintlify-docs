...
description: "Complete step-by-step guide to integrate Request Network API with a Node.js backend and React frontend"
---
...
<Frame>
<img src="/images/api-setup/integration-tutorial/folder-structure.webp" alt="Folder structure" width="381" height="429" />
</Frame>
...
Sign in to the [Request Dashboard](https://dashboard.request.network) with your wallet and create a Client ID. The Client ID is your API credential — copy it into your `.env` file.
...
<Frame>
<img src="/images/api-setup/integration-tutorial/database-studio.webp" alt="Database Studio" width="768" height="253" loading="lazy" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/ngrok-terminal.webp" alt="ngrok terminal" width="768" height="237" loading="lazy" />
</Frame>
...
Once your application is deployed, register a new webhook via `POST /v1/webhook` using your deployment's webhook route — same `curl` as above with the production URL.

Then copy the returned secret to your deployment's environment variables and you can test your handlers just as we did above.
...
We'll be using [Vite](https://vite.dev/) to create a simple React app. Move to the root directory in the created project and run `npm create vite@latest rn-test-frontend -- --template react-ts` in the terminal. Then move to the created directory `rn-test-frontend`, run `npm install`.
...
<Frame>
<img src="/images/api-setup/integration-tutorial/vite-setup.webp" alt="Vite setup" width="396" height="458" loading="lazy" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/initial-ui.webp" alt="Initial UI" width="768" height="548" loading="lazy" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/wallet-conencted.webp" alt="Wallet connected" width="768" height="521" loading="lazy" />
</Frame>

<Frame>
<img src="/images/api-setup/integration-tutorial/wallet-disconnected.webp" alt="Wallet disconnected" width="768" height="466" loading="lazy" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/view-payments.webp" alt="View payments" width="768" height="627" loading="lazy" />
</Frame>
...
```css
// src/components/create-payment/styles.css
.create-payment {
  max-width: 500px;
  margin: 0 auto;
}
...
<Frame>
<img src="/images/api-setup/integration-tutorial/create-payment-form.webp" alt="Create payment form" width="768" height="780" loading="lazy" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/create-payment-step-1.webp" alt="Create payment step 1" width="768" height="731" loading="lazy" />
</Frame>

2. Create the payment and sign the transaction

<Frame>
<img src="/images/api-setup/integration-tutorial/sign-transaction-1.webp" alt="Sign transaction 1" width="768" height="461" loading="lazy" />
</Frame>

<Frame>
<img src="/images/api-setup/integration-tutorial/sign-transaction-2.webp" alt="Sign transaction 2" width="768" height="751" loading="lazy" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/payment-in-progress.webp" alt="Payment in progress" width="768" height="711" loading="lazy" />
</Frame>

4. In a few moments the payment's status should be set to `Confirmed` .

<Frame>
<img src="/images/api-setup/integration-tutorial/payment-confirmed.webp" alt="Payment confirmed" width="768" height="800" loading="lazy" />
</Frame>
