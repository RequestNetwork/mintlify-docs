...
<Frame>
<img src="/images/api-setup/integration-tutorial/folder-structure.webp" alt="Folder structure" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/database-studio.webp" alt="Database Studio" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/ngrok-terminal.webp" alt="ngrok terminal" />
</Frame>

Next up, go back to the [Request Dashboard](https://dashboard.request.network) and add a new webhook. In the case above it's the URL from ngrok with the `/webhooks` appendix (https://34c701d1d7f9.ngrok-free.app/webhooks).

<Frame>
<img src="/images/api-setup/integration-tutorial/webhook-step-1.webp" alt="Add webhook step 1" />
</Frame>

<Frame>
<img src="/images/api-setup/integration-tutorial/webhook-step-2.webp" alt="Add webhook step 2" />
</Frame>
...
Once your application is deployed, you will need to add a new webhook via the [Request Dashboard](https://dashboard.request.network) just like we did above, but use your deployment URL's webhook route.
...
<Frame>
<img src="/images/api-setup/integration-tutorial/vite-setup.webp" alt="Vite setup" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/initial-ui.webp" alt="Initial UI" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/wallet-disconnected.webp" alt="Wallet disconnected" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/view-payments.webp" alt="View payments" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/create-payment-form.webp" alt="Create payment form" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/create-payment-step-1.webp" alt="Create payment step 1" />
</Frame>

2. Create the payment and sign the transaction

<Frame>
<img src="/images/api-setup/integration-tutorial/sign-transaction-1.webp" alt="Sign transaction 1" />
</Frame>

<Frame>
<img src="/images/api-setup/integration-tutorial/sign-transaction-2.webp" alt="Sign transaction 2" />
</Frame>
...
<Frame>
<img src="/images/api-setup/integration-tutorial/payment-in-progress.webp" alt="Payment in progress" />
</Frame>
