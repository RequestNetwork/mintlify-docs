...
<CardGroup cols={2}>
  ...
  <Card title="API Quickstart" href="/api-setup/getting-started" icon="arrow-right">
    Get started with the Request Network API
  </Card>
</CardGroup>
...
| **Supported Chains** | EVM chains (Ethereum, Polygon, etc.) + Tron | EVM chains + NEAR |
