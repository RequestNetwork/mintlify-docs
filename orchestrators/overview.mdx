...
- **Receive webhooks** — receive signed `client_id.linked` notifications after a platform completes hosted onboarding.
...
<CardGroup cols={2}>
  ...
  <Card title="Orchestrator webhooks" href="/orchestrators/webhooks" icon="webhook">
    Receive signed notifications when a platform completes hosted onboarding.
  </Card>
