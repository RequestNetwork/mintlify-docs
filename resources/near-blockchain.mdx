---
title: "NEAR (Paused)"
description: "Request Network's previous NEAR support — paused; this page is preserved for reference."
---

import { CopyButton, ExternalLinkButton } from "/snippets/contract-buttons.jsx"

<Note>
NEAR support is currently **paused**. This page is preserved for reference and is no longer linked from the main navigation. The Request Network API does not support NEAR; previous integrations were SDK-only.
</Note>

## Overview

Request Network previously supported payments on NEAR, a sharded, proof-of-stake blockchain that offers unique capabilities compared to EVM-compatible chains. NEAR's architecture enables more complex smart contract interactions through asynchronous callbacks and cross-contract calls.
