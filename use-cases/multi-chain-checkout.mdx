...
<Steps>
  ...
  <Step title="Connect a wallet">
    Any EVM wallet (MetaMask, Coinbase, WalletConnect, plus injected wallets like Rabby, Phantom-EVM) **or** any Tron wallet (TronLink, Guarda, Trust, WalletConnect-Tron). The modal lists both alongside.

    <Frame>
      <img src="/images/secure-payments/connect-wallet-tron.webp" alt="Tron wallet selection" />
    </Frame>
  </Step>

  <Step title="Pick a chain and token">
    The app shows all the payer's holdings across supported chains, with USD-equivalent balances and a banner indicating same-chain vs cross-chain.

    <Frame>
      <img src="/images/secure-payments/payment-options-crosschain.webp" alt="Cross-chain payment options with Li.Fi" />
    </Frame>
  </Step>
