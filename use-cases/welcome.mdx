...
description: "Request Network is a protocol for creating, sending, and reconciling crypto payments across EVM chains and Tron. Generate payment links, route payments crosschain, and confirm them instantly with webhooks."
...
<div style={{ padding: '2rem 2rem 0', maxWidth: '1400px', margin: '0 auto' }}>
  <div style={{ marginBottom: '2rem' }}>
    ...
    <p style={{ fontSize: '1.125rem', color: 'var(--text-secondary)', lineHeight: '1.75' }}>
      Request Network is a protocol for creating and settling payments directly between two parties on <strong className="text-zinc-950 dark:text-white">EVM chains and Tron</strong>. Generate a payment link, route the payment across chains, and get a webhook the moment it settles. No custodial hold, no manual matching against your invoices.
    </p>
  </div>
