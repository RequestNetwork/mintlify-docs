...
Transform your e-commerce checkout with Request Network's payment infrastructure. Accept crypto payments with support for 80+ wallets, enable cross-chain transactions, and provide customers with a seamless payment experience that rivals traditional payment processors.
...
<Tabs>
  <Tab title="Use EasyInvoice As-Is">
    **Best for:** Quick e-commerce integration, existing payment forms
    ...
    Embed payout functionality in existing e-commerce:
  ...
  <Tab title="Fork & Customize">
    **Best for:** Custom checkout experience, brand matching
    ...
    [Fork Repository →](#) | [Checkout Customization Guide →](#)
  </Tab>
