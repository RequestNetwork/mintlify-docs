...
<Steps>
  <Step title="Sign in to the Dashboard">
    ...
    <Frame>
      <img src="/images/dashboard/login-evm.webp" alt="Dashboard sign-in (EVM)" width="1440" height="900" />
    </Frame>
  </Step>
  ...
  <Step title="Create a payment link from the Get Paid tab">
    ...
    <Frame>
      <img src="/images/dashboard/get-paid-new.webp" alt="Create new request form" width="1280" height="720" loading="lazy" />
    </Frame>
