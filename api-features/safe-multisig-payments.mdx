...
description: "Pay a secure payment from a Gnosis Safe multisig: request Safe-ready calldata, execute on your Safe, and track settlement via the intent endpoint."
---
