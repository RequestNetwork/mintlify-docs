...
### Setup in Dashboard
1. Navigate to **Platform Settings → Webhooks** in [Request Dashboard](https://dashboard.request.network)
2. Click **Add webhook**
...
```bash
ngrok http 3000
# Use the HTTPS URL (e.g., https://abc123.ngrok.io/webhook) in the Dashboard
```
...
### Portal Testing
1. Go to **Platform Settings → Webhooks** in Request Dashboard
...
<CardGroup cols={2}>
  ...
  <Card title="Request Dashboard" href="https://dashboard.request.network" icon="browser">
    Configure webhooks and manage Client IDs
  </Card>
</CardGroup>
