export const ComparisonTable = () => {
  const comparisonData = [
    ...
    {
      method: "New Address to receive each Payment",
      accuracy: 100,
      implementation: "Very Hard",
      linesOfCode: 30,
      userExperience: "Poor",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg p-4 md:p-8">
      ...
      <div className="overflow-x-auto -mx-4 md:mx-0 px-4 md:px-0">
        <div className="min-w-[800px]">
          ...
          <div className="grid grid-cols-6 gap-3 mb-3 px-4">
            ...
            <div className="font-semibold text-xs md:text-sm text-gray-600 dark:text-gray-400">User Experience</div>
            ...
            {comparisonData.map((row, index) => (
              <div
                ...
                className={`grid grid-cols-6 gap-3 p-3 md:p-4 rounded-lg border-2 transition-all duration-200 ${
                  row.isHighlighted
                    ? "bg-green-50/50 dark:bg-green-950/20 border-green-300 dark:border-green-700 hover:bg-green-100/60 dark:hover:bg-green-950/30 hover:shadow-lg hover:border-green-400 dark:hover:border-green-600"
                    : "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/60 hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-600"
                }`}
              >
                {/* Method Name */}
